...
class ParticipantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create participant" do
    assert_difference('Participant.count') do
      post participants_url, params: { participant: { seed: @participant.seed, team_id: @participant.team_id, tournament_id: @participant.tournament_id } }
    end
  ...
  test "should update participant" do
    patch participant_url(@participant), params: { participant: { seed: @participant.seed, team_id: @participant.team_id, tournament_id: @participant.tournament_id } }
